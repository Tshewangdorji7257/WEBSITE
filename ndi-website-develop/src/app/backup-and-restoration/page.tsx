import BackupAndRestoreComponent from '@/components/UIComponents/BackupAndRestoreComponent'
...
export async function generateMetadata(): Promise<Metadata> {
  const sections = await fetchPageByName(PageNames.BACKUP_AND_RESTORE)
  if (sections) {
